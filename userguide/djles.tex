...
\begin{itemize}
 ...
 \item \verb+relax+ is the underrelaxation factor, $0 < \verb+relax+ <= 1$.
        ...
        after performing an interation, that is,
...
A successful solve will have a relative error of roughly \verb+epsilon+/\verb+relax+ decimal placesin $\eta$. Using a small value of \verb+relax+ should be accompanied with a reduction in \verb+epsilon+.
